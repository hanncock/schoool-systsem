					...
					<section class="schls">
						...
						<?php
							...
							<tr style="background:green;color:white;box-shadow:2px 4px 5px green;text-align:center;height:2.5rem;" >
								...
								$class = $_POST['class'];
								$sql = "SELECT fname,sirname,tname,othername,admno,class,stream FROM student where  class='$class' ";
								//echo $sql;
								$result=$conn->query($sql);
						...
						<?php
									...
									<tr>
										<td></td>
										<td><input type="submit" name="chargeform" value="Charge Form" style="background:green;height:2rem;box-shadow:2px 5px 5px #23263C;color:white;font-size:1rem;">
									</td>
									</tr>
									<?php
										echo "</table>";
			...
			<section class="popup" name="popup" id="popup">
								<section class="meso">
									<center>
										...
										Form Fess Has Been Charged Succesfully<br><br><br>
										<a href="">
			...
			<section class="popup" name="popup" id="popup">
								<section class="meso">
									<center>
										...
										Form Fess Has NOT Been Charged <br><br><br>
										<a href="">
										<button onload="close()" style="background:dodgerblue;border-radius:10px;width:90px;text-align:center;height:40px;border:none;color:white;">OK</button>
										</a>
									</center>
