...
<body>
	...
	<header style="background:dodgerblue;">
		<a href='editprof.php'><img src="avatar.png" id="profile" style="width:50;height:50;border-radius:50%;"></a>
	...
	<section class="questions" id="questions">
		...
		<div class="myposts">
			...
			while($row=$res->fetch_assoc()){
				?>
				<button style="min-height:2rem;font-family:cursive;color:white;width:20rem;">
				...
				<button>
					<a href='trial.php?deletequestion=<?php echo $row['id']?>'>Del</a>
				</button></span><br><br>
...
<script>
	...
	/*var prof = document.getElementById('');
