	...
	<body onload="openNav()">
		<div class="wrapper">
			...
			<div class="disp">
				...
				<div class="display">
					<div class="cont">
						<center style="background:green;color:white;"><h1 >Issue Book</h1></center>
						<form method="POST" action="#">
							<table class="table">
								...
								<tr>
									...
									<td class="inputs"><input type="text" name="category"></td>
									<td class="labels">Student:</td>
									<td class="inputs"><input type="text" name="description"></td>
									<td class="labels">From:</td>
									<td class="inputs"><input type="date" name="description"></td>
