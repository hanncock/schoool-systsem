	...
	<body onload="openNav()">
		<div class="wrapper">
			...
			<div class="disp">
				...
				<div class="display">
					<div class="cont">
						<center style="background:dodgerblue;"><h1 >Register Exams</h1></center>
						<form method="POST" action="#">
							<table class="table">
								...
								<tr>
									...
									<td class="inputs"><input type="text" name="examyear"></td>
									<td class="inputs"><input type="text" name="term"></td>
									<td class="inputs"><input type="text" name="description"></td>
								</tr>
							</table>
							<input type="submit" name="create" value="Add Exam" class="submit">
						</form>
					</div>	
				</div>
			</div>
